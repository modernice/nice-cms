...
func (m *MockRepository) Delete(arg0 context.Context, arg1 media.Document) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Get(arg0 context.Context, disk, path string) (media.Document, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Lookup(arg0 context.Context, arg1 string) (media.Document, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) Lookup(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Lookup", reflect.TypeOf((*MockRepository)(nil).Lookup), arg0, arg1)
}

// Save mocks base method.
func (m *MockRepository) Save(arg0 context.Context, arg1 media.Document) error {
	m.ctrl.T.Helper()
